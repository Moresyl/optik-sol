...
- Hardened instrumentation teardown, bounded response capture, transactional/automatic mounting, plugin cleanup, object-handle release, clipboard feedback, runtime buffer resizing, live element-tree selectors/highlighting, asynchronous IndexedDB enumeration, REPL evaluation, and legacy layout observers
